            ...
            <section className="catalog-section catalog-trending">
                ...
                <div className="catalog-filter-bar">
                    ...
                    <div className="catalog-search-wrap">
                        ...
                        />
                        {searchInput && (
                            <button className="catalog-search-clear" onClick={() => setSearchInput('')}>×</button>
                        )}
                    </div>
                </div>
                ...
                {filteredItems.length === 0 ? (
                    <div className="catalog-empty">
                        <p>Aucun modèle trouvé pour <strong>"{searchInput}"</strong> dans <strong>{activeCategory}</strong>.</p>
                        <button className="btn-outline-sm" onClick={() => { setActiveCategory('Tout'); setSearchInput(''); }}>Réinitialiser les filtres</button>
                    </div>
                ) : (
            ...
            <section className="catalog-section catalog-feature-row">
                ...
                <div className="feature-row-text">
                    ...
                    <ul className="feature-bullet-list">
                        ...
                        <li>✓ Aperçu 3D interactif par modèle</li>
                        <li>✓ Accès direct à l'éditeur en 1 clic</li>
                    </ul>
